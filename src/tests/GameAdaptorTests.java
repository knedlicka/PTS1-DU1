...
public class GameAdaptorTests {
    ...
    private void testPlay() {
        ...
        String expectedRespnse = "Optional[onTurn: 1\n" +
                ...
                "cards: {HandPosition{cardIndex=null, playerIndex=1}=Optional[Card{type=Knight, value=0}], HandPosition{cardIndex=null, playerIndex=1}=Optional[Card{type=Number, value=5}], HandPosition{cardIndex=null, playerIndex=0}=Optional[Card{type=Number, value=9}], HandPosition{cardIndex=null, playerIndex=0}=Optional[Card{type=Number, value=4}], HandPosition{cardIndex=null, playerIndex=4}=Optional[Card{type=Number, value=3}], HandPosition{cardIndex=null, playerIndex=2}=Optional[Card{type=Number, value=1}], HandPosition{cardIndex=null, playerIndex=3}=Optional[Card{type=Number, value=2}], HandPosition{cardIndex=null, playerIndex=2}=Optional[Card{type=Number, value=6}], HandPosition{cardIndex=null, playerIndex=3}=Optional[Card{type=Number, value=7}], HandPosition{cardIndex=null, playerIndex=4}=Optional[Card{type=Number, value=8}]}\n" +
